...
#define	ST95HF_TRACK_NOTHING			(0x00u)
#define	ST95HF_TRACK_NFCTYPE1 			(0x01u) /* 0000 0001 */
#define	ST95HF_TRACK_NFCTYPE2 			(0x02u) /* 0000 0010 */
#define	ST95HF_TRACK_NFCTYPE3 			(0x04u) /* 0000 0100 */
#define	ST95HF_TRACK_NFCTYPE4A 			(0x08u) /* 0000 1000 */
#define	ST95HF_TRACK_NFCTYPE4B 			(0x10u) /* 0001 0000 */
#define	ST95HF_TRACK_NFCTYPE5 			(0x20u) /* 0010 0000 */
#define ST95HF_TRACK_ALL 				(0xFFu) /* 1111 1111 */


typedef enum {
	ST95HF_IC_VERSION_UNKNOWN = 0x00,
	ST95HF_IC_VERSION_QJA = 0x30,
	ST95HF_IC_VERSION_QJB,
	ST95HF_IC_VERSION_QJC,
	ST95HF_IC_VERSION_QJD,
	ST95HF_IC_VERSION_QJE
}st95hf_ic_version_t;
...
#define ST95HF_WREG_ACC_ARC_INDEX_ACC_A 0x04
#define ST95HF_WREG_ACC_ARC_INDEX_ARC_B 0x01

typedef struct {
	uint8_t index;					/* Index pointier:		0x01: Points to the Modulation Index and Receiver Gain values in the ARC_B register
                                                            0x04: Points to Demodulator Sensitivity and Load Modulation values in ACC_A register */
    union {
        union {
            uint8_t byte;
            struct {
...
} st95hf_write_acc_arc_t;

#define ST95HF_WREG_TIMERW_CONFIRMATION     0x04
...
typedef struct {
	...
	union {
		st95hf_write_acc_arc_t acc_arc;
